...
const main = async () => {
  if (
    process.env.SPONSOR_KEY === "7819c328420c6e9e0bb34579ac9f90870a71ddd57adf2fb6245c8dde028b882c" ||
    process.env.VICTIM_KEY === "ced1d45bc7c001826de61b495dfd838f3e6796f2296b4c9849079a3585be943d"
  ) {
